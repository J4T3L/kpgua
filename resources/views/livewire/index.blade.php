    ...
    <main class="lg:min-h-screen lg:mt-0 mt-32 flex items-center lg:mb-0 mb-10">
        <div class="container px-8 mx-auto grid lg:grid-cols-2 gap-10 items-center">
            <div class="space-y-4 lg:order-1 order-2">
                <h1 class="sm:text-6xl text-gray-800 text-4xl font-['poppins'] font-black">Nikmati Hunian Nyaman di Graha Indah</h1>
                <p class="tracking-wide text-gray-600 sm:text-base text-sm">
                Temukan kamar kos dan villa siap memenuhi kebutuhan Anda. Kami menawarkan berbagai fasilitas unggulan untuk kenyamanan dan ketenangan Anda. Tertarik? Hubungi kami sekarang!
                </p>
                @auth
